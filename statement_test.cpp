...
void TestFieldAssignment() {
    ...
    ObjectHolder b = assign_y.Execute(closure, context);
...
void TestStringify() {
    ...
    {
        unique_ptr<Statement> ptr = make_unique<NumericConst>(57);
        auto result = Stringify(move(ptr)).Execute(empty, context);
